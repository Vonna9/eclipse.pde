...
public interface IOrganizeManifestsSettings {
	...
	public static final String PROP_ADD_MISSING_VERSIONS = "OrganizeManifests.addMissingVersions"; //$NON-NLS-1$
	public static final String PROP_MISSING_VERSION_OPTIONS = "OrganizeManifests.missingVersionOptions"; //$NON-NLS-1$
